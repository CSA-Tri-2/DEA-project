		...
		public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
			http
				...
				.authorizeHttpRequests(auth -> auth
					...
					.requestMatchers("/mvc/person/update/**", "/mvc/person/delete/**", "/mvc/sorting/**").authenticated()
				...
				.headers(headers -> headers
					...
					.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Headers", "Content-Type", "Authorization", "x-csrf-token", "Origin", "X-Requested-With", "Accept"))
